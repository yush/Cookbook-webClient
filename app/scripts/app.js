...
app.config(['$stateProvider', '$urlRouterProvider',
        function($stateProvider, $routeProvider) {
            $stateProvider
                ...
                .state('layout.categoriesDetails', {
                    ...
                    views: {
                        ...
                        "main": {
                            templateUrl: '/partial/categoriesDetails.html',
    ...
    .controller('SidebarCtrl', function($scope, $stateParams, synConn) {
        ...
        $scope.changeCat = function(recetteID, catID) {
            ...
            synConn.http({
                ...
                $state.go('layout.home', {}, {reload:true});
            });
        };
    })
    .controller('RecetteCtrl', function($scope, $stateParams, synConn, SynAuth, emAuth) {
        ...
        synConn.http({
            ...
            $scope.recette = data;
            synConn.getUrlSign('root/Recette/' + idRecette + '/image', function(err, url) {
    ...
    .controller('CategoriesCtrl', function($scope, $stateParams, synConn, SynAuth, emAuth) {
        console.info(synConn);
        /*
        var idCategories = $stateParams.id;
        synConn.http({
            uri: 'root/CategoriesList/' + idCategories
        }).success(function(data) {
    ...
    .controller('NewRecetteCtrl', function($scope, $stateParams, $state, FileUploader, synConn) {
        ...
        $scope.upload = function(it) {
            synConn.getUrlSign('/root/Recette/newRecette', function(err, url) {
                it.url = url;
                it.formData.push({"categorie": "Plats"});
                it.upload();
            });
        };

    }).controller('LoginCtrl', function($window, $scope, $http, $state, emAuth, synConn) {
